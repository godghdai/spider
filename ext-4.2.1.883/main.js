...
Ext.onReady(function () {
    ...
    Ext.define('ForumThread', {
        ...
        fields: [
            "positionName", "salary", "city", "workYear", "education", "company", "industryField", "financeStage", "companySize", '_id', "_from", "url"
        ],
        idProperty: '_id'
    });
        ...
        tbar: [{
            ...
            listeners: {
                click: function () {
                    ...
                    Ext.require('spider.ux.TotalWin', function () {

                        var mw = Ext.create('spider.ux.TotalWin', {
                        }).show();
                    });
